...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 36.47727272727272, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 416.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 357.0, 35.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 317.0, 196.0, 70.0, 22.0 ],
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 177.199999999999989, 172.0, 112.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 177.199999999999989, 196.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 177.199999999999989, 140.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 84.0, 237.0, 252.0, 130.0 ],
									"prototypename" : "pixl",
									"varname" : "interpol8r",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 34.0, 35.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 84.0, 79.0, 35.0, 22.0 ],
									"text" : "open"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 84.0, 103.0, 291.0, 22.0 ],
									"text" : "jit.grab @output_texture 1 @adapt 1 @drawto pacific"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 34.0, 103.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 34.0, 388.0, 337.0, 22.0 ],
									"text" : "jit.world pacific @floating 1 @esc_fullscreen 1 @size 640 360"
								}
...
,
					"patching_rect" : [ 99.0, 109.0, 55.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 38.0, 74.0, 77.0, 22.0 ],
					"text" : "unpack 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.0, 344.0, 154.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.0, 301.0, 145.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 169.0, 150.625, 102.0, 47.0 ],
...
,
					"patching_rect" : [ 38.0, 301.0, 103.5, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 38.0, 250.0, 162.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 195.0, 32.5, 23.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 38.0, 161.0, 116.0, 23.0 ],
...
,
					"patching_rect" : [ 38.0, 344.0, 103.5, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 137.0, 36.47727272727272, 71.5, 20.0 ],
					"text" : "<new case"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 150.625, 242.0, 130.75 ],
					"proportion" : 0.5,
					"rounded" : 20
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 76.5, 143.0, 279.0, 143.0, 279.0, 288.0, 132.0, 288.0 ],
					"order" : 0,
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 47.5, 184.0, 47.5, 184.0 ],
					"source" : [ "obj-67", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-12" : [ "vst~[26]", "vst~[4]", 0 ],
			"obj-6::obj-3::obj-17" : [ "range[4]", "range", 0 ],
			"obj-6::obj-3::obj-24" : [ "Vertical", "Vertical", 0 ],
			"obj-6::obj-3::obj-41" : [ "pictctrl[6]", "pictctrl[1]", 0 ],
			"obj-6::obj-3::obj-44" : [ "Scale", "Scale", 0 ],
			"obj-6::obj-3::obj-47" : [ "pictctrl[7]", "pictctrl[1]", 0 ],
			"obj-6::obj-3::obj-50" : [ "pictctrl[8]", "pictctrl[1]", 0 ],
			"obj-6::obj-3::obj-51" : [ "pictctrl[5]", "pictctrl[1]", 0 ],
			"obj-6::obj-3::obj-53" : [ "pictctrl[4]", "pictctrl[1]", 0 ],
			"obj-6::obj-3::obj-54" : [ "Bound", "Bound", 0 ],
			"obj-6::obj-3::obj-56::obj-23" : [ "gswitch2[2]", "gswitch2", 0 ],
			"obj-6::obj-3::obj-68" : [ "Horizontal", "Horizontal", 0 ],
			"obj-6::obj-3::obj-94" : [ "Interpolation", "Interpolation", 0 ],
			"parameterbanks" : 			{
