...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 84.0, 103.0, 301.0, 22.0 ],
									"text" : "jit.grab @output_texture 1 @adapt 1 @drawto hispanic"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 34.0, 388.0, 347.0, 22.0 ],
									"text" : "jit.world hispanic @floating 1 @esc_fullscreen 1 @size 640 360"
								}
